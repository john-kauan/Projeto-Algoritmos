...
void insertion_menu(){
    ...
    do{
        printf("===INSERTION SORT - TIPO DE ENTRADA===\n");
        printf("c - Crescente\n");
            ...
            case 'r':
                do {
                    ...
                    if (tamanho_entrada >= 1 && tamanho_entrada <= 6) {
                        ...
                        sprintf(entrada_path, "Resultados/InsertionSort/Entradas/%s/Entrada%s%d.txt", nome_tipo, nome_tipo, n);
                        ...
                        char saida_path[256];
                        sprintf(saida_path, "Resultados/InsertionSort/Saidas/%s/Saida%s%d.txt", nome_tipo, nome_tipo, n);
                        salvar_dados(saida_path, vetor, n);

                        // Salvar o arquivo de tempo
                        char tempo_path[256];
                        sprintf(tempo_path, "Resultados/InsertionSort/Tempo/%s/Tempo%s%d.txt", nome_tipo, nome_tipo, n);
